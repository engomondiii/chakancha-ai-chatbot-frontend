/**
 * ProductGrid.jsx
 * Responsive product grid with category filter bar and sort controls.
 * Uses CSS Grid — adapts from 1 to 4 columns.
 */
 ...
 * @param {boolean} showFilters   - Show category + sort bar
 * @param {Array}   categories    - Category objects for filter bar
 */
