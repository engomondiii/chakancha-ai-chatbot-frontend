...
const MOCK_PRODUCTS = [
  {
    ...
    images:        [
      { url: '/images/products/black-tea-1.jpg', is_primary: true,  sort_order: 0 },
      { url: '/images/products/black-tea-2.jpg', is_primary: false, sort_order: 1 },
    ],
  ...
  },
  {
    ...
    images:        [{ url: '/images/products/green-tea-1.jpg', is_primary: true, sort_order: 0 }],
  ...
  },
  {
    ...
    images:        [{ url: '/images/products/purple-tea-1.jpg', is_primary: true, sort_order: 0 }],
  ...
  },
  {
    ...
    images:        [{ url: '/images/products/white-tea-1.jpg', is_primary: true, sort_order: 0 }],
