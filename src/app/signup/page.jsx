    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          alignItems: 'center', gap: 'var(--spacing-lg)', textAlign: 'center',
        }}>
          {/* Icon */}
          <div style={{
          ...
          {/* Steps */}
          <div style={{
            width: '100%', backgroundColor: 'var(--color-warm-cream)',
            border: '1px solid var(--color-border)', borderRadius: 'var(--radius-lg)',
            padding: 'var(--spacing-lg)', display: 'flex', flexDirection: 'column', gap: 10,
          }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{
                  ...
                  <span style={{ fontFamily: 'var(--font-sans)', fontSize: 11, fontWeight: 700, color: 'white' }}>
                    {i + 1}
                  </span>
                </div>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: 14, color: 'var(--color-text-primary)', margin: 0 }}>
                  {step}
                </p>
              </div>
            ))}
          ...
          <p style={{
            ...
            <button
              ...
              style={{
                ...
                color: 'var(--color-tea-green)', fontWeight: 500,
                fontFamily: 'var(--font-sans)', fontSize: 13,
              }}
            >
              try again
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: 14, color: 'var(--color-text-secondary)', textAlign: 'center', margin: 0 }}>
          ...
          <a href="/login" style={{ color: 'var(--color-tea-green)', fontWeight: 500, textDecoration: 'none' }}>
            Sign in
          </a>
        </p>
      </div>
