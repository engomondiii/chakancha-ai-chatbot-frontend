...
import { Leaf, Truck, Heart, Star, ShieldCheck } from 'lucide-react';
...
function ProductCatalog() {
  ...
  const { products, isLoading, error } = useProducts({ category: categoryParam });
    ...
    >
      ...
      <div
        style={{
          ...
          padding:         '48px 40px',
          background:      'linear-gradient(135deg, rgba(45,80,22,0.05) 0%, rgba(212,165,116,0.08) 100%)',
      ...
      >
        ...
        <p style={{
          ...
          Every tea on this page was grown at high altitude by farmers
          earning a living wage — not just a minimum wage. When you buy
          Chakancha tea, you taste the difference that dignity makes.
        </p>
        ...
        <p style={{
          ...
          Black, green, purple, white — each one a different expression
          of the same extraordinary hills. Find your cup below.
        </p>
      ...
      <div style={{
        ...
        gap:            16,
        background:     'linear-gradient(135deg, rgba(45,80,22,0.06) 0%, rgba(212,165,116,0.08) 100%)',
